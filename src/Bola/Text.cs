...
internal static class Text
{
    internal static void Register()
    {
        ...
        localization.AddTranslation("English",new Dictionary<string,string> {
            ...
            ["bola_bound"]="Entangled",["bola_immune"]="Bola immunity",["bola_local_only"]="This Bola test build supports local solo play only.",
        ...
        localization.AddTranslation("Norwegian",new Dictionary<string,string> {
            ...
            ["bola_bound"]="Fastbundet",["bola_immune"]="Immun mot bola",["bola_local_only"]="Denne testversjonen av Bola støtter bare lokal spilling alene.",
